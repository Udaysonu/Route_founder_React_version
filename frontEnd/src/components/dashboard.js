...
class Dashboard extends Component {
 ...
 <Link to={"/dashboard/bookings"}  > <div class="dashboard_control" ><a  > <img class="dash_image"  src="/bookings.png"/><div class="middle"> <div class="text">Bookings</div> </div>  </a>    </div></Link>
